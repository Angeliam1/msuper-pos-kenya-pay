...
import { TrendingUp, DollarSign, ShoppingBag, Smartphone } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{mpesaTransactions}</div>
            <p className="text-xs text-muted-foreground">{cashTransactions} cash payments</p>
          </CardContent>
        </Card>
      </div>
