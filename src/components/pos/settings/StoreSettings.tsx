  ...
  return (
    <div className="relative z-10">
      <Tabs defaultValue="info" className="w-full">
        ...
        <TabsContent value="products" className="relative z-10">
          <Card>
            <CardHeader>
        ...
        <TabsContent value="customers" className="relative z-10">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        <TabsContent value="suppliers" className="relative z-10">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
